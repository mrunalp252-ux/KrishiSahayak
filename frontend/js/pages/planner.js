                ...
                <div style="min-width:320px; max-width:480px; width:100%;">
                    ...
                    <form id="add-activity-form">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="3" placeholder="Notes, fertilizer quantities, or irrigation hours..."></textarea>
                        </div>
                ...
                onLoad: (modal, close) => {
                    ...
                    form.addEventListener('submit', async (e) => {
                        ...
                        try {
                            ...
                            window.Utils.showToast('Activity added successfully!', 'success');
                            close(true);
                            this.loadActivities();
                        } catch (err) {
